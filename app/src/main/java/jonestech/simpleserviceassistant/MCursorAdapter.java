...
public class MCursorAdapter extends CursorAdapter {
    ...
    String empty = "";
    String hours, magazines, brochures, books, tracts, returnvisits, biblestudies, pioncred = "";
    ...
    public void bindView(View v, Context ct, Cursor cs){
        ...
        String d = cs.getString(cs.getColumnIndexOrThrow(dh.KEY_DATE));
        Integer h =  cs.getInt(cs.getColumnIndexOrThrow(dh.KEY_H));
        Integer m =  cs.getInt(cs.getColumnIndexOrThrow(dh.KEY_M));
        Integer br = cs.getInt(cs.getColumnIndexOrThrow(dh.KEY_BRCH));
        Integer bo = cs.getInt(cs.getColumnIndexOrThrow(dh.KEY_BOOK));
        Integer t =  cs.getInt(cs.getColumnIndexOrThrow(dh.KEY_T));
        Integer rv = cs.getInt(cs.getColumnIndexOrThrow(dh.KEY_RV));
        Integer s =  cs.getInt(cs.getColumnIndexOrThrow(dh.KEY_S));
        String c = cs.getString(cs.getColumnIndexOrThrow(dh.KEY_D));
        Integer pc = cs.getInt(cs.getColumnIndexOrThrow(dh.KEY_PC));
        date.setText(d);
        ...
        list.setText(hours+magazines+brochures+books+tracts+returnvisits+biblestudies+pioncred);
        comm.setText(c);
    }
}