...
/**
 * Created by Josiah on 1/23/2015.
 */
public class SMS_Report_Class extends Activity {
    Report report;
    String empty = "";
    ...
    public void send(View view){
        ...
        if(pmonthcheckbox.isChecked()){
            if(prevmonthmethod(pmymethod()+"").equals(getString(R.string.no_email))){
                ...
                intent.putExtra("sms_body", getString(R.string.report_for)+" "+pmonthyearmethod()+"\n"+
                        prevmonthmethod(pmymethod()+""));
                if(intent.resolveActivity(getPackageManager()) != null){startActivity(intent);}else{
                    Toast.makeText(this, getString(R.string.no_sms_app), Toast.LENGTH_LONG).show();
                }
            }
        }
        if(cmonthcheckbox.isChecked()){
            if(curmonthmethod(cmymethod()+"").equals(getString(R.string.no_email))){
                ...
                intent.putExtra("sms_body", getString(R.string.report_for)+" "+cmonthyearmethod()+"\n"+
                        curmonthmethod(cmymethod()+""));
