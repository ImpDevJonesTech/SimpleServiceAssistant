...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.add_report){
            Intent intent = new Intent(this, Add_Report_Class.class);
        ...
        if(id == R.id.send_email){
            Intent ei = new Intent(this, Email_Report_Class.class);
            ei.setFlags(ei.getFlags() | Intent.FLAG_ACTIVITY_NO_HISTORY);
            ei.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            ei.putExtra("EXIT", true);
            startActivity(ei);
            return true;
        }
        if(id == R.id.send_sms){
            Intent smsi = new Intent(this, SMS_Report_Class.class);
            smsi.setFlags(smsi.getFlags() | Intent.FLAG_ACTIVITY_NO_HISTORY);
            smsi.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            smsi.putExtra("EXIT", true);
            startActivity(smsi);
            return true;
        }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    fragment = new Day_frag();
                    break;
                case 1:
                    fragment = new Month_frag();
                    break;
                case 2:
                    fragment = new Year_frag();
                    break;
            }
            return fragment;
        }
