...
public class Edit_Report_Class extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        EditText video = (EditText)findViewById(R.id.videos);
        ...
        br = mintent.getIntExtra("br", 0);bo = mintent.getIntExtra("bo", 0);t = mintent.getIntExtra("t", 0); vs = mintent.getIntExtra("vs", 0);
        ...
        if(vs == 0){video.setText("");}else{video.setText(vs+"");}
    ...
    public void save(View view){
        ...
        EditText videos = (EditText)findViewById(R.id.videos);
        ...
        if(videos.getText().toString().isEmpty()){vs = 0;}else{vs = Integer.parseInt(videos.getText().toString());}
        ...
        if(hour.getText().toString().isEmpty() && mags.getText().toString().isEmpty() &&
            ...
            db.updateDetail(mid, h, m, br, bo, t, rv, s, co, pc, vs);
            c.requery();
